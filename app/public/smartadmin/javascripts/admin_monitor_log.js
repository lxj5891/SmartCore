...
function render() {
  ...
  $("#table_id").dataTable( {
    ...
    "aoColumns": [
      ...
      { "sTitle": "時間", "mData": "userName" ,"sClass": "left"},
      { "sTitle": "用户", "mData": "first" ,"sClass": "left"},
      { "sTitle": "源", "mData": "middle" ,"sClass": "left"},
      { "sTitle": "类型", "mData": "last" ,"sClass": "left"},
      { "sTitle": "级别", "mData": "_id" ,"sClass": "left"},
      { "sTitle": "类别", "mData": "_id" ,"sClass": "left"},
      { "sTitle": "编码", "mData": "_id" ,"sClass": "left"},
      { "sTitle": "详细", "mData": "_id" ,"sClass": "left"}
    ],
    "aoColumnDefs": [
      {
        "aTargets": [5],
