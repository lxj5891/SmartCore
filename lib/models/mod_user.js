 ...
 * @param {String} code 公司code
 * @param {String} uid 用户标识
 * @param {Object} extendKey 扩展标识
 * @param {Object} extendValue 扩展值
 * @param {Function} callback 回调函数，返回更新后的用户
 */
exports.updateExtendProperty = function (code, uid, extendKey, extendValue, callback) {
  ...
  user.findByIdAndUpdate(uid, extend, function (err, result) {
