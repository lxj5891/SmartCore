...
exports.add = function(handler, callback) {
  ...
  try {
    ...
    check(group.visibility, __("group.error.emptyVisibility")).notEmpty();
    check(group.visibility, __("group.error.invalidVisibility")).isIn(
      [constant.GROUP_VISIBILITY_PRIVATE, constant.GROUP_VISIBILITY_PUBLIC]);
